	...
	player
		proc
			...
			*/
			...
			FireSlash(mob/player/P,mob/monsters/M)
				var/damage = (P.tempstr + P.tempdex + rand(-10,10)) - (M.tempstr + M.tempdex + rand(-M.mrand,M.mrand))
				var/chancehit = ((P.tempagl + (rand(7,14))/10) + rand(-100,100)) - ((M.tempagl + (rand(7,14))/10) + rand(-100,100))
				var/chancehit2 = rand(0,2)
				var/critical = ((P.templuk + P.tempagl + P.tempdex + rand(0,50))*2) - (M.templuk + M.tempagl + M.tempdex + rand(0,50))
			...
			IceSlash(mob/player/P,mob/monsters/M)
				var/damage = (P.tempstr + P.tempdex + rand(-10,10)) - (M.tempstr + M.tempdex + rand(-M.mrand,M.mrand))
				var/chancehit = ((P.tempagl + (rand(7,14))/10) + rand(-100,100)) - ((M.tempagl + (rand(7,14))/10) + rand(-100,100))
				var/chancehit2 = rand(0,2)
				var/critical = ((P.templuk + P.tempagl + P.tempdex + rand(0,50))*2) - (M.templuk + M.tempagl + M.tempdex + rand(0,50))
			...
			LightningSlash(mob/player/P,mob/monsters/M)
				var/damage = (P.tempstr + P.tempdex + rand(-10,10)) - (M.tempstr + M.tempdex + rand(-M.mrand,M.mrand))
				var/chancehit = ((P.tempagl + (rand(7,14))/10) + rand(-100,100)) - ((M.tempagl + (rand(7,14))/10) + rand(-100,100))
				var/chancehit2 = rand(0,2)
				var/critical = ((P.templuk + P.tempagl + P.tempdex + rand(0,50))*2) - (M.templuk + M.tempagl + M.tempdex + rand(0,50))
			...
			WindSlash(mob/player/P,mob/monsters/M)
				var/damage = (P.tempstr + P.tempdex + rand(-10,10)) - (M.tempstr + M.tempdex + rand(-M.mrand,M.mrand))
				var/chancehit = ((P.tempagl + (rand(7,14))/10) + rand(-100,100)) - ((M.tempagl + (rand(7,14))/10) + rand(-100,100))
				var/chancehit2 = rand(0,2)
				var/critical = ((P.templuk + P.tempagl + P.tempdex + rand(0,50))*2) - (M.templuk + M.tempagl + M.tempdex + rand(0,50))
			...
			EarthSlash(mob/player/P,mob/monsters/M)
				var/damage = (P.tempstr + P.tempdex + rand(-10,10)) - (M.tempstr + M.tempdex + rand(-M.mrand,M.mrand))
				var/chancehit = ((P.tempagl + (rand(7,14))/10) + rand(-100,100)) - ((M.tempagl + (rand(7,14))/10) + rand(-100,100))
				var/chancehit2 = rand(0,2)
				var/critical = ((P.templuk + P.tempagl + P.tempdex + rand(0,50))*2) - (M.templuk + M.tempagl + M.tempdex + rand(0,50))
