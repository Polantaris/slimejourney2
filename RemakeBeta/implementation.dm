...
mob/var/list/base_saved_verbs	// If we're saving verbs they are stored here.
mob
...
mob/BaseCamp/ChoosingCharacter
	...
	proc/DeleteCharacterMenu(list/menu)
		...
		var/default = null
		var/menu_choice = input(src, "Which character do you want to delete?", "Deleting character", default) in menu
